          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="bootstrap/production/images/logo.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <!-- sidebar menu -->
            <!-- sidebar menu -->
            <div id="sidebar-menu fixed-sidebar" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3>Admin</h3>
                <ul class="nav side-menu">
                  <li><a href="/"><i class="fa fa-user"></i>Dokter </a></li>
                  <li><a href="{{route('jadwal.create')}}"><i class="fa fa-pencil"></i>Input Jadwal </a></li>
                  <li><a href="{{route('jadwal.index')}}"> <i class= "fa fa-calendar"></i>Jadwal </a></li>
                  <li><a href=""><i class="fa fa-desktop"></i>Jadwal  Terpilih</a></li>
            ...
            <div class="sidebar-footer hidden-small ">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="{{route('loginAdmin.update',1)}}">
